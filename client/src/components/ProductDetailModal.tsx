...
export function ProductDetailModal({
  ...
  const description =
    (product.description as any)?.[language] || "Product Description";
        ...
        <div className="flex flex-col md:flex-row h-full">
                ...
                <>
                  {isVideoUrl(mediaItems[currentImageIndex]) ? (
                    ...
                    <img
                      ...
                      className="w-full h-full object-cover object-center ml-[70px] mr-[70px] pl-[0px] pr-[0px]"
          ...
          <div className="md:w-1/2 p-6 overflow-y-auto max-h-[60vh] md:max-h-full touch-pan-y">
            <div className="mb-4">
              <Badge
                className={
                  qualityTier?.className || "bg-muted text-muted-foreground"
                }
              >
                {qualityLabel}
              </Badge>
              ...
              <div className="mb-6">
                ...
                <ul className="text-muted-foreground text-sm space-y-1">
                  {specifications.map((spec: string, index: number) => (
                    <li
                      key={index}
                      className={language === "my" ? "font-myanmar" : ""}
                    >
                      • {spec}
                    </li>
                  ))}
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {contactInfo
                  .filter((contact) => contact.isActive && contact.url)
                  .map((contact) => {

      ...
      <section id="about" className="py-16 bg-[#F5F5DC]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="prose prose-lg mx-auto">
            <p className="text-muted-foreground mb-6 text-center text-[17px]">မင်္ဂလာပါ စတုန်နာအမျိုးတို့... DeeDo ZeeYoသည် ၂၀၂၂ခုနှစ် မှစတင်ကာ ဝိအဖူးအပွင့်များကိုစတင်ရောင်းချခဲ့ပြီး Customersများအတွက် အကောင်းဆုံးCannabisထုတ်ကုန်များကိုသာ ရောင်းချနိုင်ရန် အမြဲတမ်း အစဥ်မပြတ်ကြိုးစားလျက် ရှိပါသည်။ Customers များနှင့်လည်းခိုင်မာသော ယုံကြည်မှုကို တည်ဆောက်ထားနိုင်ပြီး အမြဲတမ်း အားပေးကူညီခဲ့ကြသော Customers များအားလုံးကို အထူးပင် ကျေးဇူးတင်ရှိပါသည်။ ဒီWebsite က ညိုရဲ့ (DeedoZeeyo)နဲ့ စတုန်နာအမျိုးတို့အမြဲတမ်းအဆက်အသွယ်ရှိနေနိုင်စေရန်ဖန်တီးထားတာကြောင့် Website Linkလေးကို မှတ်ထားဖို့လည်း စတုန်နာအမျိုးတွေကို Requestလုပ်ပါတယ်။ ဆက်လက်၍လည်း အကောင်းဆုံးဝန်ဆောင်မှု၊ အကောင်းဆုံးCannabisထုတ်ကုန်တွေသာ ပေးစွမ်းနိုင်အောင် ကြိုးစားသွားပါမယ်ရှင့်။</p>
